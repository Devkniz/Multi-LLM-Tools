...
# Everything AI coding assistant Conventions

> Generated from [affaan-m/everything-the AI assistant-code](https://github.com/affaan-m/everything-the AI assistant-code) on 2026-03-20

## Overview

This skill teaches the AI assistant the development patterns and conventions used in everything-the AI assistant-code.
...
```text
feat: add block-no-verify hook for AI coding assistant and Cursor (#649)
```
