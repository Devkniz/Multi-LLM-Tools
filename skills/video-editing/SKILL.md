...
## Layer 2: Organization (the AI assistant / Codex)

Use AI coding assistant or Codex to:
...
Use the AI assistant to analyze transcript + scene timestamps:
```
...
|------|----------|----------|
| the AI assistant / Codex | Organization, planning, code generation | Not the creative taste layer |
