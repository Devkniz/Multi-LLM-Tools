...
- Coordinating work across AI coding assistant, Codex, and other harnesses
...
- Supports: AI coding assistant, Codex, OpenCode, Cline, Gemini, Qwen
...
```
Pane 1 (AI coding assistant): "Review the security of the auth module"
Pane 2 (Codex): "Refactor the utility functions for performance"
Pane 3 (AI coding assistant): "Write E2E tests for the checkout flow"
```
...
# Pane 1: cd ../feature-auth && the AI assistant
# Pane 2: cd ../feature-billing && the AI assistant
...
| **AI coding assistant Task tool** | In-process subagent spawning | Programmatic parallelism within a session |
